...
export const SLIDERS = [
  { key: "bright_thresh", label: "Brightness sensitivity", min: 1, max: 120, step: 1, default: 18,
    ...
    hideWhen: "auto_bright" },  // hidden while Auto brightness is on
  { key: "tophat_size", label: "Cell isolation size", min: 5, max: 61, step: 2, default: 15,
    hint: "Slightly larger than a cell. Increase for bigger cells." },
  { key: "min_radius", label: "Min cell radius (px)", min: 1, max: 100, step: 1, default: 2 },
  { key: "max_radius", label: "Max cell radius (px)", min: 2, max: 200, step: 1, default: 9 },
  { key: "min_circularity", label: "Roundness filter", min: 0, max: 1, step: 0.05, default: 0.55,
    hint: "Higher = stricter; rejects grid lines and debris." },
  { key: "max_aspect", label: "Max elongation", min: 1, max: 6, step: 0.1, default: 2.2,
    hint: "Lower = reject more line-like shapes (grid lines)." },
  { key: "min_extent", label: "Min fill", min: 0, max: 1, step: 0.02, default: 0.42,
    hint: "Higher = reject sparse shapes that aren't solid round cells." },
  ...
  { key: "v_dead_max", label: "Dead darkness max", min: 0, max: 255, step: 5, default: 170,
    hint: "Dead (blue) cells darker than this." },
...
export const TOGGLES = [
  ...
  { key: "use_watershed", label: "Split touching cells", default: false },
];
